...
>(({ className, align = "center", sideOffset = 16, ...props }, ref) => (
	<HoverCardPrimitive.Content ref={ref} align={align} sideOffset={sideOffset} className={cn(
		"z-20 max-w-48 rounded bg-light/75 px-3 py-2 text-sm text-dark shadow-lg outline-none backdrop-blur backdrop-saturate-200 dark:bg-dark/75 dark:text-light",
